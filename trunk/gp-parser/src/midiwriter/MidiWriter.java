...
public class MidiWriter
{
  ...
  public void setBPM(int bpm) {
	  int calc = 60000000 / bpm;
	  byte[] byteArray = ByteBuffer.allocate(4).putInt(calc).array();
	  System.out.println(byteArray[0]+","+byteArray[1]+","+byteArray[2]+","+byteArray[3]);
	  tempoEvent[4] = byteArray[1];
	  tempoEvent[5] = byteArray[2];
	  tempoEvent[6] = byteArray[3];
    ...
    throws Exception
  {
    ...
    mf.noteOnOffNow (4, -1, 127);
    mf.noteOnOffNow (4, -1, 127);
    mf.noteOnOffNow (QUAVER, 71, 127);
    mf.noteOnOffNow (SEMIQUAVER, 69, 127);
    mf.noteOnOffNow (SEMIQUAVER, 59, 127);
    mf.noteOnOffNow (SEMIQUAVER, 69, 127);
    mf.noteOnOffNow (QUAVER, 71, 127);
    mf.noteOnOffNow (SEMIQUAVER, 69, 127);
